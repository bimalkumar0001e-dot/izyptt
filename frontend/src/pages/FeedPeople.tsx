...
const motivationalBanners = [
  ...
  },
  {
    ...
    backgroundColor: 'bg-gradient-to-r from-pink-300 to-pink-500'
  },
  {
    id: 3,
    image: '/placeholder.svg',
    ...
    backgroundColor: 'bg-gradient-to-r from-rose-400 to-pink-600'
  },
  {
    id: 4,
    image: '/placeholder.svg',
      ...
      <div className="flex-1 pb-20">
              ...
              {motivationalBanners.map((banner) => (
                <CarouselItem key={banner.id}>
                  <Card className="overflow-hidden">
                    <div className={`relative h-48 ${banner.backgroundColor} flex items-center justify-center text-white`}>
        ...
        <div className="px-4 mb-6">
          <div className="grid grid-cols-2 gap-4">
            <Button 
              className="h-20 flex flex-col items-center justify-center bg-pink-500 hover:bg-pink-600"
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600 mb-3">
                We'll print your name and occasion wishes on the packaging so recipients know who's sharing this kindness.
              </p>
